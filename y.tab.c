...
#line 1 "ass3_14CS10005.y" /* yacc.c:339  */
...
union YYSTYPE
{
#line 7 "ass3_14CS10005.y" /* yacc.c:355  */
...
static const char *const yytname[] =
{
  ...
  "COMPLEX", "IMAGINARY", "ONELINE_COMMENT", "MULTI_LINE_COMMENT",
  "IDENTIFIER", "INTEGER_NO", "FLOAT_NO", "ENUMERATION_CONSTANT",
  "CHARACTER", "STRING", "LEFT_SQUARE_BRACK", "RIGHT_SQUARE_BRACK",
  "LEFT_ROUND_BRACK", "RIGHT_ROUND_BRACK", "LEFT_CURLY_BRACK",
  "RIGHT_CURLY_BRACK", "DOT", "ARROW", "INCREM", "DECREM", "AMPEAND",
  "MULTIPLICATION", "ADDITION", "SUBTRACTION", "TILDA", "NEGAT",
  "FORWARD_SLA", "percent", "LEFT_SHIFT", "RIGHT_SHIFT", "LESS_THAN",
  "GREATER_THAN", "LES_EQUAL", "GREAT_EQUAL", "EQUAL_EQUAL", "NOT_EQUAL",
  "EXCLUSIVE_OR", "OR", "B_AND", "B_OR", "ELLIPSIS", "QUESTION", "COLON",
  "SEMI_COLON", "EQUAL", "ST_EQUAL", "SLASH_EQUAL", "percent_EQUAL",
  "add_EQUAL", "MINUS_EQUAL", "LEFT_SHIFT_EQUAL", "RIGHT_SHIFT_EQUAL",
  "AND_EQUAL", "X_EQUAL", "OR_EQUAL", "COMMA", "HASH", "$accept",
...
#line 112 "ass3_14CS10005.y" /* yacc.c:1906  */
